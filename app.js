        ...
        <div id="sec-ai" style="display:none">
          <div class="settings-section"><div class="settings-section-title">🤖 AI服务配置</div>
            ...
            <div class="settings-section"><div class="settings-section-title">API配置</div>
              ...
              <div class="settings-row" style="flex-direction:column;align-items:flex-start;gap:8px">
                <div style="width:100%">
                  <div class="settings-label">代理服务器</div>
                  <input type="text" id="aiProxyUrlInput" value="${s.aiProxyUrl||'http://localhost:8080'}" placeholder="http://localhost:8080" style="width:100%;margin-top:4px" onchange="saveSetting('aiProxyUrl',this.value)">
                  <div style="font-size:11px;color:var(--text3);margin-top:4px">需要先运行: python proxy_server.py</div>
                </div>
              </div>
            </div>
...
async function testAIConnection() {
  ...
  const useProxy = settings.useAiProxy !== false;
